...
{
    public partial class ImportarDiagnosticos : Form
    {
        public ImportarDiagnosticos()
        {
            InitializeComponent();
        }
        ...
        private void btnImportar_Click(object sender, EventArgs e)
        {
            if (txtRuta.Text != "" && Convert.ToInt64(cmbAsociacion.SelectedIndex) != -1)
            {
                try
                {
                    ...
                    Conexion.SQLHelper.ExecuteNonQuery("ImportarDiagnostico", CommandType.StoredProcedure, parameterList);
                    MessageBox.Show("Diagnosticos Importados Correctamente", "");
                }
